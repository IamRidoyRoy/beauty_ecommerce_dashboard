...
export default function CourierPage(){
  ...
  return <>
    <PageHeader title="Courier" description="Submit Packed orders to Pathao, Steadfast, RedX or CarryBee. Successfully submitted orders become Shipped; courier tracking syncs automatically and confirmed deliveries update the order to Delivered."/>
