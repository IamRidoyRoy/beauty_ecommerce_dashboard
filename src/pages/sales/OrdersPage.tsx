...
export default function OrdersPage(){
  ...
  return <>
    <PageHeader title="Orders" description="Search and process orders with direct invoice and print actions." actions={can(user,'orders_write')?<button className="btn-brand" onClick={()=>nav('/sales/orders/new')}><Plus size={16}/>Create Order</button>:undefined}/>
