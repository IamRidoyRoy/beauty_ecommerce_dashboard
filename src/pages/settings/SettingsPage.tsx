...
import {MapPinned,Plus,ShieldCheck,Truck,Route} from 'lucide-react'
...
export default function SettingsPage(){
  ...
  return <>
    <PageHeader title="Settings" description="Checkout security, delivery areas and shipping methods." actions={<button className="btn-brand" onClick={save}>Save Settings</button>}/>
    <div className="grid gap-5 lg:grid-cols-3">
      ...
      <section className="panel p-6"><div className="mb-5 flex items-center gap-3"><span className="rounded-xl bg-pink-50 p-2.5 text-pink-700"><MapPinned size={19}/></span><div><h2 className="font-semibold">Delivery pricing</h2><p className="text-xs text-zinc-400">District defaults and thana-level subarea overrides.</p></div></div><Link className="btn-secondary" to="/sales/delivery">Manage Delivery Areas</Link></section>
