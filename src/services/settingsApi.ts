...
import type {CheckoutSettings,SearchResult,StaffAccessOptions,User} from '../types'
...
export const settingsApi=baseApi.injectEndpoints({endpoints:b=>({
  ...
  staffAccessOptions:b.query<StaffAccessOptions,void>({query:()=>'/admin/staff-access-options/',transformResponse:tr,providesTags:['Staff']}),
...
export const {useSettingsQuery,useUpdateSettingsMutation,useLazyGlobalSearchQuery,useStaffQuery,useStaffAccessOptionsQuery,useCreateStaffMutation,useUpdateStaffMutation,useDeleteStaffMutation}=settingsApi
