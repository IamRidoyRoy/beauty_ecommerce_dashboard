...
// Searchable country choices for Product Beauty Information. Values remain readable strings
// and are compatible with the existing backend country_of_origin text field.
